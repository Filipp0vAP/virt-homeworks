...
С первой попытки не создалось так как яндексу не понравилось имя образа

![FirtsTry](./img/FirstTry.png)

Поправил имя и взлетело

![SecondTry](./img/SecondTry.png)

И собственно вид в консоли на созданные ресурсы:
...
В принципе его можно использовать, так как основной файл конфига становиться более читаемым и менее громоздким.
